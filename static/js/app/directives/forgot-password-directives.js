...
.directive('ensureCorrect', function (apiService) {
  return {
    // 监控属性mgModel是否发生变化
    ...
    link: function (scope, iEle, iAttrs, ctrl) {
      ...
      // 输入完验证码，浏览器请求到服务器返回之间会短时间出现 mobileForm.$invalid 为false，因为这时候除了$error.correct之外，其他$error都是false。
