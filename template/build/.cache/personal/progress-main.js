/*TMODJS:{"version":2,"md5":"80a505c928f2d6a3e145c90b3c8f42df"}*/
...
$out+='</h3> </div> <div class="wp-body" id="progress-list"> <div class="table-wrap"> <table class="table-one table-base"> <thead> <tr> <th width="28%">课程</th> <th width="42%">进度</th> <th width="15%">观看时间</th> <th width="15%">状态</th> </tr> </thead> <tbody id="progress-content"> ';
