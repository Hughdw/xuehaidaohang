...
var amdOptimize = require('amd-optimize'); // require的模块包装插件
var eventstream = require('event-stream'); // 在一个task钟整合多个文件来源
var htmlmin = require('gulp-htmlmin'); // HTML压缩
var imagemin = require('gulp-imagemin'); // 图片压缩
var minifycss = require('gulp-minify-css'); // css压缩
var jshint = require('gulp-jshint'); // js检测
var uglify = require('gulp-uglify'); // js压缩
var concatFile = require('gulp-concat'); // 文件合并
var rename = require('gulp-rename'); // 文件更名
var notify = require('gulp-notify'); // 提示信息
var rev = require('gulp-rev'); // 添加MD5后缀
var revCollector = require('gulp-rev-collector'); // 根据gulp-rev生成的路径映射进行替换
